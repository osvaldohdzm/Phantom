/**
 * Development Next.js server with HTTPS (same certs as production).
 * Hot-reload via next({ dev: true }).
 */
...
const app = next({ dev: true, hostname: bindAddress, port });
...
createServer(httpsOptions, (req, res) => {
  ...
  console.log(`[+] Next.js development HTTPS on ${bindLabel}:${port}`);
