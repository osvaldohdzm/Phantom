...
export type AssetScanTargetImportResult = {
  ...
  promoted: number;
  promote_source_type?: string | null;
...
export async function listResponsableUsers(): Promise<ResponsableUser[]> {
  return apiFetch<ResponsableUser[]>('/api/v1/engagements/responsables');
}
